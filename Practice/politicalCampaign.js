...
// and the corresponding properties for each, to represent the following
//  information about Elizabeth's campaign.
const campaign = {
  ...
  ElizabethSanger: [
    ...
    },
    {
     ...
     {
       CalendarOfEvents: {
        localFundraiser: "Car Wash Fundraiser! 10-30-19"
       }
      },
